...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            {{-- @yield('scout') --}}
            <form method="POST" action="{{ route('scout.linkParent') }}">
                @csrf
                <div class="page-content">
                    <div class="row">
                        <div class="col-md-12 stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title">Link Parent</h6>
                                    <form>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="parent_username"
                                    ...
                                    <button type="submit" class="btn btn-primary submit">Add Parent</button>
                                    @if (session('error'))
