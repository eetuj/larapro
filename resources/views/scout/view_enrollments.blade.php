                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-baseline mb-2">
                            <h6 class="card-title mb-0">{{ $scout->name }}</h6>
                        </div>
                            ...
                            <tbody>
                                @foreach ($enrollments as $enrollment)
                                    <tr>
                                        ...
                                        <td>{{ $enrollment->event->starts_at }}</td>
                                        <td>
                                            <form  action ="{{ route('scout.unenroll', ['event' => $enrollment->event]) }}"  method="post">
                                                @csrf
                                                <div class="input-group">
                                                    <input type="text" name="unenroll_reason" class="form-control" placeholder="Enter reason for unenrollment" required>
                                                    <button type="submit" class="btn btn-danger">Unenrolllll</button>
                                                </div>
                                            </form>
                                        </td>
                                        <!-- Add other enrollment fields as needed -->
